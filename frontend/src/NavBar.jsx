...
const NavBar = () => {
    return (
        <div className="  cursor-pointer flex justify-around items-center h-16 border-b-gray-300 border-b-1 w-full">
            <h1 className="text-lg md:text-2xl font-bold">BlogVerse</h1>
            ...
            <div className=" flex gap-5 justify-center items-center">
                ...
                <Link to="/signup" className="hover:bg-blue-700 bg-blue-600 text-white px-3 md:px-5 py-2 rounded-lg cursor-pointer">SignUp</Link>
            </div>
        </div>
    )
}
